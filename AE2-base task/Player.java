...
public class Player {
    ...
    public boolean Taketurn(Scanner scan) {      
        System.out.println("developer's perspective of "+name+"'s board: \n"+playboard.toString1());
        //"toString1" methods is for developer to cheat when testing the game, they show all the ships' status
        System.out.println(
        ...
        System.out.println("player's perspective of "+name+"'s board: \n"+playboard.toString());//show the board          
        if (playboard.numofdestroyedships == 5)// destroyed all the enemy ships                                                                                                      // enemy ships
            return true;
        else
            return false;
